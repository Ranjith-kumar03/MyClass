...
public class UpdateStudentAsync extends AsyncTask<Integer,Void, Student> {
    private Context context;
    private Student student;
    private callBackInteface<Student> callBack;
    private Exception exception;

    public UpdateStudentAsync(Context context, Student student, callBackInteface<Student> callBack) {
    ...
    protected Student doInBackground(Integer... integers) {
       try {
           Connection.getInstance(context).getDatabase().getStudentDAO().updateStudent(student);
